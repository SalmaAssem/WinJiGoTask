...
namespace XWinji.Models
{
    ...
    public partial class LMSApplicationCoreCommandsOffice365Office365AddTenantSchoolCommand
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LMSApplicationCoreCommandsOffice365Office365AddTenantSchoolCommand
        /// class.
        /// </summary>
        public LMSApplicationCoreCommandsOffice365Office365AddTenantSchoolCommand()
        {
            CustomInit();
        }
        ...
        /// class.
        /// </summary>
        public LMSApplicationCoreCommandsOffice365Office365AddTenantSchoolCommand(string schoolName = default(string), string schoolId = default(string), string schoolLogoUrl = default(string), bool? showNameWithLogo = default(bool?), int? learnersAccessLevel = default(int?), bool? allowExternalUsers = default(bool?), bool? isInheritedFromTenant = default(bool?), string studentsFile = default(string), string teachersFile = default(string), string staffFile = default(string), string themeName = default(string), bool? isEnableRounds = default(bool?), bool? isEnableTracks = default(bool?), bool? isCertificateEnabled = default(bool?), bool? isEnableChatBetweenLearners = default(bool?), bool? isEnableAttendance = default(bool?), bool? isEnableGradebook = default(bool?), bool? isEnableCustomizeAttendanceInSegment = default(bool?), bool? isEnableLearnersToAddSpace = default(bool?), IList<LMSApplicationCoreViewModelOffice365ManageSubjectViewModel> subjects = default(IList<LMSApplicationCoreViewModelOffice365ManageSubjectViewModel>), IList<LMSApplicationCoreViewModelOffice365ManageGradeViewModel> grades = default(IList<LMSApplicationCoreViewModelOffice365ManageGradeViewModel>), string customBackgroundColor = default(string), string customForegroundColor = default(string), string customButtonColor = default(string), int? evaluationCycleTypeId = default(int?), bool? disableSwitchNotifications = default(bool?), IList<LMSApplicationCoreViewModelEvaluationCycleViewModel> evaluationCycles = default(IList<LMSApplicationCoreViewModelEvaluationCycleViewModel>), IList<LMSApplicationCoreViewModelGradeCreditHoursViewModel> gradeCreditHours = default(IList<LMSApplicationCoreViewModelGradeCreditHoursViewModel>), string parentId = default(string), string externalId = default(string), int? typeId = default(int?), string organizationId = default(string), IList<LMSApplicationCoreCommandsAttendanceStatusAddCommand> attendanceStatuses = default(IList<LMSApplicationCoreCommandsAttendanceStatusAddCommand>), IList<LMSApplicationCoreCommandsGradeBookGradeCategoryCommand> gradeCategoriesList = default(IList<LMSApplicationCoreCommandsGradeBookGradeCategoryCommand>))
        {
            ...
            IsEnableCustomizeAttendanceInSegment = isEnableCustomizeAttendanceInSegment;
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "IsEnableCustomizeAttendanceInSegment")]
        public bool? IsEnableCustomizeAttendanceInSegment { get; set; }
