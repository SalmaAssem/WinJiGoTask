...
namespace XWinji.Models
{
    ...
    public partial class LMSApplicationCoreCommandsSystemReportsCoursesReportCommand
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LMSApplicationCoreCommandsSystemReportsCoursesReportCommand class.
        /// </summary>
        public LMSApplicationCoreCommandsSystemReportsCoursesReportCommand()
        {
            CustomInit();
        }
        ...
        /// LMSApplicationCoreCommandsSystemReportsCoursesReportCommand class.
        /// </summary>
        public LMSApplicationCoreCommandsSystemReportsCoursesReportCommand(System.DateTime? durationStartDate = default(System.DateTime?), System.DateTime? durationEndDate = default(System.DateTime?), string selectedSchoolId = default(string), string selectedOrgId = default(string), int? duration = default(int?), int? pageSize = default(int?), int? pageNumber = default(int?), bool? applyOnSubSchools = default(bool?))
        {
